...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/data/cpython-mingw/mingw64/bin',
 'BINLIBDEST': '/data/cpython-mingw/mingw64/lib/python3.10',
 'BLDLIBRARY': '-L. -lpython3.10',
 'BLDSHARED': '/data/cpython-mingw/cc.sh -shared -Wl,--enable-auto-image-base '
              '-rtlib=compiler-rt -target x86_64-w64-mingw32',
 'BUILDEXE': '.exe',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/data/cpython-mingw/cc.sh',
 'CCSHARED': '',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -target x86_64-w64-mingw32',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-target x86_64-w64-mingw32',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-DMS_DLL_ID=\'"3.10"\' '
                            '-DPY3_DLLNAME=\'"libpython3.dll"\'',
 'CONFIGURE_CPPFLAGS': '-I./PC  -I.',
 'CONFIGURE_LDFLAGS': '-rtlib=compiler-rt -target x86_64-w64-mingw32',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/data/cpython-mingw/mingw64' "
                "'--host=x86_64-w64-mingw32' "
                "'--build=x86_64-unknown-linux-gnu' '--enable-shared' "
                "'--enable-static' '--without-ensurepip' "
                "'--enable-optimizations' '--without-c-locale-coercion' "
                "'--enable-loadable-sqlite-extensions' "
                "'build_alias=x86_64-unknown-linux-gnu' "
                "'host_alias=x86_64-w64-mingw32' "
                "'CC=/data/cpython-mingw/cc.sh' 'CFLAGS=-target "
                "x86_64-w64-mingw32' 'LDFLAGS=-rtlib=compiler-rt -target "
                "x86_64-w64-mingw32'",
 'CONFINCLUDEDIR': '/data/cpython-mingw/mingw64/include',
 'CONFINCLUDEPY': '/data/cpython-mingw/mingw64/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/data/cpython-mingw/coverage.info',
 'COVERAGE_REPORT': '/data/cpython-mingw/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I./PC  -I.',
 'CXX': '/data/cpython-mingwcxx.sh',
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': '/data/cpython-mingw/mingw64 /data/cpython-mingw/mingw64/lib '
             '/data/cpython-mingw/mingw64/lib/python3.10 '
             '/data/cpython-mingw/mingw64/lib/python3.10/lib-dynload',
 'DESTLIB': '/data/cpython-mingw/mingw64/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/data/cpython-mingw/mingw64/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/data/cpython-mingw/mingw64/include '
                   '/data/cpython-mingw/mingw64/include '
                   '/data/cpython-mingw/mingw64/include/python3.10 '
                   '/data/cpython-mingw/mingw64/include/python3.10',
 'INCLUDEDIR': '/data/cpython-mingw/mingw64/include',
 'INCLUDEPY': '/data/cpython-mingw/mingw64/include/python3.10',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/data/cpython-mingwcxx.sh -shared '
                '-Wl,--enable-auto-image-base',
 'LDFLAGS': '-rtlib=compiler-rt -target x86_64-w64-mingw32',
 'LDLIBRARY': 'libpython3.10.dll.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/data/cpython-mingw/cc.sh -shared -Wl,--enable-auto-image-base '
             '-rtlib=compiler-rt -target x86_64-w64-mingw32',
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/data/cpython-mingw/mingw64/lib/python3.10',
 'LIBDIR': '/data/cpython-mingw/mingw64/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/data/cpython-mingw/mingw64/lib/pkgconfig',
 'LIBPL': '/data/cpython-mingw/mingw64/lib/python3.10/config-3.10-x86_64-linux-gnu',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/data/cpython-mingw/cc.sh',
 ...
 'MACHDESTLIB': '/data/cpython-mingw/mingw64/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/data/cpython-mingw/cc.sh',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/data/cpython-mingw/mingw64/share/man',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/data/cpython-mingw '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/data/cpython-mingw/`cat pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__win32_x86_64-linux-gnu '
                     'python3.10',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-target x86_64-w64-mingw32 -std=c99 -Wextra '
                             ...
                             '-DMS_DLL_ID=\'"3.10"\' '
                             '-DPY3_DLLNAME=\'"libpython3.dll"\'  '
                             '-I./Include/internal -I. -I./Include -I./PC  -I. '
                             '-DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -target x86_64-w64-mingw32',
 'PY_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                     ...
                     '-fvisibility=hidden -D_WIN32_WINNT=0x0601 '
                     '-DMS_DLL_ID=\'"3.10"\' '
                     '-DPY3_DLLNAME=\'"libpython3.dll"\'  -I./Include/internal',
 'PY_COERCE_C_LOCALE': 0,
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -target x86_64-w64-mingw32 '
                   '-std=c99 -Wextra -Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -Wstrict-prototypes '
                   '-Werror=implicit-function-declaration -fvisibility=hidden '
                   '-D_WIN32_WINNT=0x0601 -DMS_DLL_ID=\'"3.10"\' '
                   '-DPY3_DLLNAME=\'"libpython3.dll"\'  -I./Include/internal '
                   '-I. -I./Include -I./PC  -I. -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-rtlib=compiler-rt -target x86_64-w64-mingw32',
 'PY_CPPFLAGS': '-I. -I./Include -I./PC  -I.',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': 0,
 'PY_LDFLAGS': '-rtlib=compiler-rt -target x86_64-w64-mingw32',
 'PY_LDFLAGS_NODIST': '',
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                        '-DNDEBUG -g -fwrapv -O3 -Wall -target '
                        'x86_64-w64-mingw32 -std=c99 -Wextra '
                        '-Wno-unused-result -Wno-unused-parameter '
                        '-Wno-missing-field-initializers -Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden -D_WIN32_WINNT=0x0601 '
 ...
 'RCFLAGS': '-DFIELD3=150 -O COFF --target=pe-x86-64',
 'READELF': 'x86_64-w64-mingw32-readelf',
 'RESSRCDIR': 'Mac/Resources/framework',
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/data/cpython-mingw/mingw64/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'VENVLAUNCHERDIR': '/data/cpython-mingw/mingw64/lib/python3.10/venv/scripts/nt',
 'VERSION': '3.10',
 'VPATH': '/data/cpython-mingw',
 'VPATH_b2h': '/data/cpython-mingw',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/data/cpython-mingw',
 'abs_builddir_b2h': '/data/cpython-mingw',
 'abs_srcdir': '/data/cpython-mingw',
 'abs_srcdir_b2h': '/data/cpython-mingw',
 'datarootdir': '/data/cpython-mingw/mingw64/share',
 'exec_prefix': '/data/cpython-mingw/mingw64',
 'prefix': '',
 'prefix_b2h': '',
 'srcdir': '/data/cpython-mingw',
 'srcdir_b2h': '/data/cpython-mingw'}

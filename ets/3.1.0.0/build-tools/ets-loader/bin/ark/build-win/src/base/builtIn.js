...
exports.expandFunc = exports.expandFalse = exports.expandTrue = exports.expandNull = exports.expandSymbol = exports.expandUndefined = exports.expandGlobal = exports.expandInfinity = exports.expandNaN = exports.expandHole = void 0;
...
function expandFunc(pandaGen) {
    var vreg = vregisterCache_1.getVregisterCache(pandaGen, vregisterCache_1.CacheList.FUNC);
    return [
        new irnodes_1.EcmaLdfunction(),
        new irnodes_1.StaDyn(vreg)
    ];
}
exports.expandFunc = expandFunc;

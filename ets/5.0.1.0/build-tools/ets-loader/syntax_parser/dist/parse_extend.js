...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(extendAttributes) {
  ...
  function peg$parseextendAttribute() {
  ...
  function peg$parseattribute() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseattr_head();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseattr_tail();
      if (s2 !== peg$FAILED) {
        s1 = [s1, s2];
        s0 = s1;
      } else {

...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c4 = function(whiteSpace1, prefix_extend, funcBody_extend, whiteSpace2, right, whiteSpace3) {
        return whiteSpace1 + prefix_extend + funcBody_extend + whiteSpace2 + right + whiteSpace3;
      },
      peg$c5 = "@Extend",
      peg$c6 = peg$literalExpectation("@Extend", false),
      peg$c7 = "(",
      ...
      peg$c15 = function(whiteSpace1, component, whiteSpace2, whiteSpace3, function_name, whiteSpace4, parameters, whiteSpace5, left) {
      ...
      peg$c18 = function(whiteSpace1, component, function_name, whiteSpace2, parameters, whiteSpace3, left) {
        collect_extend.component.push(component);
        collect_extend.functionName.push(function_name);
        collect_extend.parameters.push(parameters);
  ...
  function peg$parseextend() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parseprefix_extend();
      if (s2 !== peg$FAILED) {
        s3 = peg$parsefuncBody_extend();
        if (s3 !== peg$FAILED) {
  ...
  function peg$parseprefix_extend() {
    var s0;

    s0 = peg$parseprefix_extend_one();
    if (s0 === peg$FAILED) {
      s0 = peg$parseprefix_extend_another();
    }

    return s0;
  }

  function peg$parseprefix_extend_one() {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                ...
                                if (s15 !== peg$FAILED) {
                                  peg$savedPos = s0;
                                  s1 = peg$c15(s2, s4, s6, s8, s9, s10, s12, s14, s15);
                                  s0 = s1;
                                } else {
                                  peg$currPos = s0;
                                  s0 = peg$FAILED;
  ...
  function peg$parseprefix_extend_another() {
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          peg$savedPos = s0;
                          s1 = peg$c18(s2, s3, s5, s6, s8, s10, s11);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$FAILED;
  ...
  function peg$parsefunction_name() {
    ...
    s0 = peg$currPos;
    s1 = peg$currPos;
    s2 = peg$parsefunction_name_head();
    if (s2 !== peg$FAILED) {
      s3 = peg$parsefunction_name_tail();
      if (s3 !== peg$FAILED) {
        s2 = [s2, s3];
        s1 = s2;
      } else {
  ...
  function peg$parsefunction_name_head() {
    var s0, s1, s2;
  ...
  function peg$parsefunction_name_tail() {
    var s0, s1, s2;
  ...
  function peg$parsefuncBody_extend() {
    var s0, s1, s2, s3, s4, s5, s6;

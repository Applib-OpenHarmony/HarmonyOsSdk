import { EcmaCloseiterator, EcmaCopydataproperties, EcmaCopymodule, EcmaCreatearraywithbuffer, EcmaCreateemptyarray, EcmaCreateemptyobject, EcmaCreateobjecthavingmethod, EcmaCreateobjectwithbuffer, EcmaCreateobjectwithexcludedkeys, EcmaCreateregexpwithliteral, EcmaDefineasyncfunc, EcmaDefineclasswithbuffer, EcmaDefinefuncdyn, EcmaDefinegeneratorfunc, EcmaDefinegettersetterbyvalue, EcmaDefinemethod, EcmaDefinencfuncdyn, EcmaGetiterator, EcmaGetiteratornext, EcmaGetnextpropname, EcmaGetpropiterator, EcmaImportmodule, EcmaIsfalse, EcmaIstrue, EcmaLdglobalvar, EcmaLdhomeobject, EcmaLdlexenvdyn, EcmaLdlexvardyn, EcmaLdmodvarbyname, EcmaLdobjbyindex, EcmaLdobjbyname, EcmaLdsuperbyname, EcmaNewlexenvdyn, EcmaNewlexenvwithnamedyn, EcmaNewobjdynrange, EcmaPoplexenvdyn, EcmaReturnundefined, EcmaSetobjectwithproto, EcmaStarrayspread, EcmaStclasstoglobalrecord, EcmaStconsttoglobalrecord, EcmaStglobalvar, EcmaStlettoglobalrecord, EcmaStlexvardyn, EcmaStmodulevar, EcmaStobjbyindex, EcmaStobjbyname, EcmaStownbyindex, EcmaStownbyvalue, EcmaStownbyvaluewithnameset, EcmaStsuperbyname, EcmaStsuperbyvalue, EcmaSupercall, EcmaSupercallspread, EcmaThrowconstassignment, EcmaThrowdeletesuperproperty, EcmaThrowifnotobject, EcmaThrowifsupernotcorrectcall, EcmaThrowpatternnoncoercible, EcmaThrowthrownotexists, EcmaThrowundefinedifhole, EcmaTryldglobalbyname, EcmaTrystglobalbyname, IRNode, Label, VReg } from "../irnodes";
...
export declare function newLexicalEnv(numVars: number, scopeInfoIdx: number | undefined): EcmaNewlexenvdyn | EcmaNewlexenvwithnamedyn;

...
var GeneratorFunctionBuilder = /** @class */ (function () {
    ...
    GeneratorFunctionBuilder.prototype.prepare = function (node, recorder) {
        ...
        pandaGen.createGeneratorObj(node, vregisterCache_1.getVregisterCache(pandaGen, vregisterCache_1.CacheList.FUNC));
    ...
    GeneratorFunctionBuilder.prototype.yield = function (node, value) {
        ...
        pandaGen.EcmaCreateiterresultobj(node, value, vregisterCache_1.getVregisterCache(pandaGen, vregisterCache_1.CacheList.False));
    ...
    GeneratorFunctionBuilder.prototype.yieldStar = function (expr) {
        ...
        this.compiler.compileFinallyBeforeCFC(undefined, compiler_1.ControlFlowChange.Break, undefined);
    ...
    GeneratorFunctionBuilder.prototype.cleanUp = function () {

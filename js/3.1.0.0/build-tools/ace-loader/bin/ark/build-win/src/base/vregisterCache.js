...
(function (CacheList) {
    ...
    CacheList[CacheList["FUNC"] = 2] = "FUNC";
    CacheList[CacheList["Infinity"] = 3] = "Infinity";
    CacheList[CacheList["undefined"] = 4] = "undefined";
    // Boolean,
    // Number,
    // String,
    // BigInt,
    CacheList[CacheList["Symbol"] = 5] = "Symbol";
    // RegExp,
    CacheList[CacheList["Null"] = 6] = "Null";
    // Object,
    // Function,
    CacheList[CacheList["Global"] = 7] = "Global";
    CacheList[CacheList["LexEnv"] = 8] = "LexEnv";
    CacheList[CacheList["True"] = 9] = "True";
    CacheList[CacheList["False"] = 10] = "False";
    CacheList[CacheList["MAX"] = 11] = "MAX";
...
var cacheExpandHandlers = new Map([
    ...
    [CacheList.FUNC, builtIn_1.expandFunc],
]);
